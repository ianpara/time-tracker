        ...
        <div className="w-full">
            {time.map((time) => (
                <div className="px-4 xs:px-0 xs:mx-auto lg:mx-0" key={time.title}>
                    ...
                    <div className="relative p-6 bg-card-background rounded-xl -mt-10 hover:cursor-pointer">
                        ...
                        <div className="flex md:flex-col items-center md:items-start justify-between">
                            <p className="text-2xl lg:text-5xl font-light text-white md:mb-3">{time.timeframes[currentTime].previous}hrs</p>
